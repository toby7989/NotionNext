...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '有效期科技', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '有效期科技欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ldianpu.tk', // 网站地址
